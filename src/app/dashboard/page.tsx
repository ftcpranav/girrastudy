    ...
    <AppLayout>
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        <div>
          <div className="flex items-center gap-2 mb-1">
            <h1 className="text-2xl md:text-3xl font-extrabold text-slate-900 dark:text-slate-100 tracking-wide">
              Welcome, {profile?.full_name || 'HSC Student'}
            </h1>
            <span className="px-2.5 py-1 rounded-full bg-amber-500/15 border border-amber-500/25 text-amber-600 dark:text-amber-400 font-bold text-xs flex items-center gap-1">
              <Flame className="h-3.5 w-3.5 fill-amber-500" />
              <span>5 Day Streak</span>
            </span>
          </div>
          <p className="text-slate-600 dark:text-slate-400 text-sm">
            Girraween High School • <strong className="text-emerald-600 dark:text-emerald-400 font-mono">{getDaysUntilHsc()} Days</strong> until HSC Final Exams 🎓
          </p>
        </div>

        {/* Global Stats Box */}
        <div className="flex items-center gap-4 bg-white/90 dark:bg-slate-900/40 border border-slate-200 dark:border-emerald-500/20 px-6 py-3 rounded-2xl backdrop-blur-sm shadow-sm">
          <div>
            <span className="text-[10px] uppercase font-bold text-slate-500 dark:text-slate-400 block">Overall Average</span>
            <span className="text-2xl font-black text-emerald-600 dark:text-emerald-400 font-mono">
              {calculateOverallAverage()}%
            </span>
          </div>
          <div className="h-8 w-px bg-slate-200 dark:bg-emerald-500/20" />
          <div>
            <span className="text-[10px] uppercase font-bold text-slate-500 dark:text-slate-400 block">Tasks Completed</span>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3.5 mb-8">
        <button
          ...
          className="flex items-center gap-3 p-3.5 bg-emerald-500/10 hover:bg-emerald-500/20 border border-emerald-500/20 hover:border-emerald-500/30 text-emerald-700 dark:text-emerald-300 font-semibold rounded-2xl transition-all cursor-pointer group shadow-sm"
        >
          <div className="p-2 rounded-xl bg-emerald-500/20 text-emerald-600 dark:text-emerald-400 group-hover:scale-110 transition-transform">
            <Plus className="h-4.5 w-4.5" />
          </div>
          <div className="text-left">
            <span className="text-xs block font-bold">Add Task</span>
            <span className="text-[10px] text-emerald-600/80 dark:text-emerald-400/80 font-normal">New deadline</span>
          </div>
        </button>

        <button
          onClick={() => router.push('/atar-calculator')}
          className="flex items-center gap-3 p-3.5 bg-amber-500/10 hover:bg-amber-500/20 border border-amber-500/20 hover:border-amber-500/30 text-amber-700 dark:text-amber-300 font-semibold rounded-2xl transition-all cursor-pointer group shadow-sm"
        >
          <div className="p-2 rounded-xl bg-amber-500/20 text-amber-600 dark:text-amber-400 group-hover:scale-110 transition-transform">
            <Calculator className="h-4.5 w-4.5" />
          </div>
          <div className="text-left">
            <span className="text-xs block font-bold">ATAR Estimator</span>
            <span className="text-[10px] text-amber-600/80 dark:text-amber-400/80 font-normal">Scaling graphs</span>
          </div>
        </button>

        <button
          onClick={() => router.push('/focus-timer')}
          className="flex items-center gap-3 p-3.5 bg-pink-500/10 hover:bg-pink-500/20 border border-pink-500/20 hover:border-pink-500/30 text-pink-700 dark:text-pink-300 font-semibold rounded-2xl transition-all cursor-pointer group shadow-sm"
        >
          <div className="p-2 rounded-xl bg-pink-500/20 text-pink-600 dark:text-pink-400 group-hover:scale-110 transition-transform">
            <Timer className="h-4.5 w-4.5" />
          </div>
          <div className="text-left">
            <span className="text-xs block font-bold">Focus Timer</span>
            <span className="text-[10px] text-pink-600/80 dark:text-pink-400/80 font-normal">Soundscapes</span>
          </div>
        </button>
        ...
        >
          ...
          <div className="text-left">
            ...
            <span className="text-[10px] text-amber-600/80 dark:text-amber-400/80 font-normal">Past papers & syllabus</span>
          </div>
        </button>
        ...
        >
          ...
          <div className="text-left">
            ...
            <span className="text-[10px] text-emerald-600/80 dark:text-emerald-400/80 font-normal">Textbook/links</span>
          </div>
        </button>

        <button
          onClick={() => router.push('/markbook')}
          className="flex items-center gap-3 p-3.5 bg-slate-100 dark:bg-slate-900/40 hover:bg-slate-200 dark:hover:bg-slate-900/60 border border-slate-200 dark:border-emerald-500/20 text-slate-800 dark:text-slate-300 font-semibold rounded-2xl transition-all cursor-pointer group shadow-sm"
        >
          <div className="p-2 rounded-xl bg-slate-200 dark:bg-slate-800 text-slate-600 dark:text-slate-400 group-hover:scale-110 transition-transform">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div>
            <div className="border-b border-slate-200 dark:border-slate-800 pb-2 flex items-center justify-between">
              ...
              <button
                ...
                className="px-3 py-1 bg-emerald-500/15 hover:bg-emerald-500/25 border border-emerald-500/25 text-emerald-600 dark:text-emerald-400 font-bold text-xs rounded-xl transition-all cursor-pointer flex items-center gap-1.5 shadow-sm"
              >
              ...
              {enrolledSubjects.map((sub) => {
                ...
                return (
                  <button
                    ...
                    className="w-full glass-card hover:bg-slate-50 dark:hover:bg-slate-900/40 p-5 rounded-2xl flex flex-col text-left transition-all hover:scale-[1.01] cursor-pointer group shadow-sm"
                  >
                    <div className="flex items-center justify-between mb-3 w-full">
                      ...
                      <span className="text-[10px] bg-slate-100 dark:bg-slate-900 text-slate-600 dark:text-slate-400 border border-slate-200 dark:border-slate-800 px-2 py-0.5 rounded-md font-mono shrink-0">
                        {sub.subject?.code}
                      </span>
                    </div>
                    ...
                    <div className="mt-2 w-full">
                      <div className="flex items-center justify-between text-xs mb-1">
                        <span className="text-slate-500 dark:text-slate-400 font-semibold">Weighted Avg</span>
                      ...
                      <div className="w-full bg-slate-200 dark:bg-slate-950 rounded-full h-1.5 overflow-hidden">
                        <div
                          className={`h-full rounded-full transition-all duration-500 ${
                            metrics.average ? getProgressColor(parseFloat(metrics.average)) : 'bg-slate-400 dark:bg-slate-800'
                          }`}
                    ...
                    {/* Sub-Metrics Row */}
                    <div className="grid grid-cols-2 gap-4 mt-5 w-full pt-3 border-t border-slate-200 dark:border-slate-800">
                      <div>
                        <span className="text-[10px] text-slate-500 dark:text-slate-400 uppercase font-bold block">Assessments</span>
                        <span className="text-xs font-semibold text-slate-700 dark:text-slate-300">
                          {metrics.assessmentCount} recorded
                        </span>
                      </div>
                      <div>
                        <span className="text-[10px] text-slate-500 dark:text-slate-400 uppercase font-bold block">Next Deadline</span>
                        <span className="text-xs font-semibold text-slate-700 dark:text-slate-300">
                          {metrics.nextDueDate}
                        </span>
                      </div>
        ...
        <div className="space-y-6">
          ...
          <div>
            <h2 className="text-lg font-bold text-slate-900 dark:text-slate-200 tracking-wide border-b border-slate-200 dark:border-slate-800 pb-2">
              ...
              {assessments
                ...
                .map((ast) => {
                  ...
                  return (
                    <div
                      key={ast.id}
                      className="p-4 glass-card rounded-2xl flex items-start gap-3.5 shadow-sm"
                    >
                      <span
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <h4 className="text-xs font-bold text-slate-900 dark:text-slate-200 truncate">{ast.name}</h4>
              ...
              {recentNotes.map((note) => {
                ...
                return (
                  <button
                    ...
                    className="w-full text-left p-4 glass-card hover:bg-slate-50 dark:hover:bg-slate-900/40 rounded-2xl flex items-center justify-between transition-colors cursor-pointer group shadow-sm"
                  >
                    <div className="flex items-center gap-3.5 min-w-0">
                      <div className="p-2.5 rounded-xl bg-slate-100 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 group-hover:scale-105 transition-transform shrink-0">
                        {getNoteIcon(note.note_type)}
                      </div>
                      <div className="min-w-0">
                        <h4 className="text-xs font-bold text-slate-900 dark:text-slate-200 truncate">{note.title}</h4>
                        <span className="text-[10px] text-slate-500 dark:text-slate-400 truncate block mt-0.5">
                          {note.subject?.name} • #{note.topic}
                        </span>
                      </div>
                    </div>
                    <ArrowRight className="h-4 w-4 text-slate-400 group-hover:text-emerald-500 group-hover:translate-x-0.5 transition-all shrink-0 ml-2" />
                  </button>
                );
              })}
